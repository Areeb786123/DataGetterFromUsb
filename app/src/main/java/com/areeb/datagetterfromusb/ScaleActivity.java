...
import com.areeb.datagetterfromusb.R;
...
public class ScaleActivity extends Activity implements Runnable {
    ...
    private static final int VID = 3768;
    private static final int PID = 61440;
    ...
    private void updateWeightPounds(int weight) {
        String result;
        Log.e("aweight", weight + "");
        float pounds = (float) weight / 100.0f;
        result = String.format("%.2f lbs", pounds);
